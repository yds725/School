...
public class LetterInventoryTest {
	...
	public void testInventoryConstructor() {
		...
		CharCompare in = new CharCompare(sb.toString());
	...
	@Test
	public void testSet() {
		CharCompare in = new CharCompare("");
	...
	public void testAdd() {
		...
		CharCompare in1 = new CharCompare(s1);
		String s2 = "ajjjjrrrsss";
		CharCompare in2 = new CharCompare(s2);
		CharCompare in3 = in1.add(in2);
	...
	public void testSubtract() {
		...
		String s2 = "ajjjjrrrsss";
		CharCompare in2 = new CharCompare(s2);
		CharCompare in3 = in1.contains(in2); // should be null since no
		// j's in in1
		assertTrue(in3 == null);
		// in1 and in2 are unchanged
		assertTrue(checkInventory(in1, s1));
		...
		in2 = new CharCompare(s2);
		in3 = in1.contains(in2);
		// in1 and in2 are unchanged
		assertTrue(checkInventory(in1, s1));
		assertTrue(checkInventory(in2, s2));
		// in3 contains s1 - s2
	...
	private boolean checkInventory(CharCompare in, String s) {
		int size = 0;
		int[] count = new int[26];
